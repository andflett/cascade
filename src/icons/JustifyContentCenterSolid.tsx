...
const JustifyContentCenterSolid = forwardRef<SVGSVGElement, CascadeIconProps>(
...
JustifyContentCenterSolid.displayName = "JustifyContentCenterSolid";
export { JustifyContentCenterSolid };
