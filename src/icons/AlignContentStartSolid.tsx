...
const AlignContentStartSolid = forwardRef<SVGSVGElement, CascadeIconProps>(
...
AlignContentStartSolid.displayName = "AlignContentStartSolid";
export { AlignContentStartSolid };
