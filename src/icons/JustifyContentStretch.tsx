...
const JustifyContentStretch = forwardRef<SVGSVGElement, CascadeIconProps>(
...
JustifyContentStretch.displayName = "JustifyContentStretch";
export { JustifyContentStretch };
