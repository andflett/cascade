...
const AlignSelfBaselineSolid = forwardRef<SVGSVGElement, CascadeIconProps>(
...
AlignSelfBaselineSolid.displayName = "AlignSelfBaselineSolid";
export { AlignSelfBaselineSolid };
