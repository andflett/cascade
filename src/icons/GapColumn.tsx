...
const GapColumn = forwardRef<SVGSVGElement, CascadeIconProps>(
  ({ color = "currentColor", solid, ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M1 0h3a1 1 0 0 1 1 1v13a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-13a1 1 0 0 1 1 -1zM1 1h3v13h-3zM11 0h3a1 1 0 0 1 1 1v13a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-13a1 1 0 0 1 1 -1zM11 1h3v13h-3z" fill={color} fillRule="evenodd" />
