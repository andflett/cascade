...
const JustifyContentFlexEndSolid = forwardRef<SVGSVGElement, CascadeIconProps>(
...
JustifyContentFlexEndSolid.displayName = "JustifyContentFlexEndSolid";
export { JustifyContentFlexEndSolid };
