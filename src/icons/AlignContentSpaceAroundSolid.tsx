...
const AlignContentSpaceAroundSolid = forwardRef<SVGSVGElement, CascadeIconProps>(
...
AlignContentSpaceAroundSolid.displayName = "AlignContentSpaceAroundSolid";
export { AlignContentSpaceAroundSolid };
