...
const JustifyContentSpaceAroundSolid = forwardRef<SVGSVGElement, CascadeIconProps>(
...
JustifyContentSpaceAroundSolid.displayName = "JustifyContentSpaceAroundSolid";
export { JustifyContentSpaceAroundSolid };
