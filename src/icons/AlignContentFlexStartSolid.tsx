...
const AlignContentFlexStartSolid = forwardRef<SVGSVGElement, CascadeIconProps>(
...
AlignContentFlexStartSolid.displayName = "AlignContentFlexStartSolid";
export { AlignContentFlexStartSolid };
